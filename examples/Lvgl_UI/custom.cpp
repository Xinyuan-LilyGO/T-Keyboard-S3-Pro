 ...
 * @LastEditTime: 2024-09-20 08:43:53
 * @License: GPL 3.0
 */
#include <Arduino.h>
#include <stdio.h>
...
void My_Lvgl_UI::LCD_CS_Set(uint8_t device_address, uint8_t lcd_cs_value, uint32_t delay_ms)
{
    IIC_Bus->IIC_WriteC8D8(device_address,
                           T_KEYBOARD_S3_PRO_WR_LCD_CS, lcd_cs_value); // 选定屏幕
    delay(delay_ms);
}
...
void Window_Home_Loop(void)
{
    if (My_UI.Window_Unlock_Flag == false)
    {
        if (My_UI.Device_Number == 1)
        {
            ...
            {
            case 1:
                My_UI.LCD_CS_Set(IIC_MAIN_DEVICE_ADDRESS, 0B00010000, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case 2:
                My_UI.LCD_CS_Set(IIC_MAIN_DEVICE_ADDRESS, 0B00001000, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case 3:
                My_UI.LCD_CS_Set(IIC_MAIN_DEVICE_ADDRESS, 0B00000100, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case 4:
                My_UI.LCD_CS_Set(IIC_MAIN_DEVICE_ADDRESS, 0B00000010, IIC_LCD_CS_DEVICE_DELAY);
        ...
        if (My_UI.Device_Number == 2)
        {
            ...
            case 5:
                ...
                break;
            case 6:
                My_UI.LCD_CS_Set(IIC_SLAVE_DEVICE_ADDRESS, 0B00010000, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case 7:
                My_UI.LCD_CS_Set(IIC_SLAVE_DEVICE_ADDRESS, 0B00001000, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case 8:
                My_UI.LCD_CS_Set(IIC_SLAVE_DEVICE_ADDRESS, 0B00000100, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case 9:
                My_UI.LCD_CS_Set(IIC_SLAVE_DEVICE_ADDRESS, 0B00000010, IIC_LCD_CS_DEVICE_DELAY);
                ...
                break;
            case 10:
                My_UI.LCD_CS_Set(IIC_SLAVE_DEVICE_ADDRESS, 0B00000001, IIC_LCD_CS_DEVICE_DELAY);
    ...
    if (My_UI.Window_Unlock_Flag == false)
    {
        ...
        if (My_UI.Device_Number == 2)
        {
            ...
            case 6:
                ...
                Window_Key_Mode_Data_Refresh(&guider_ui, &_15_alpha_128x128, &_41_alpha_128x128);
                // Update current Clock layout.
                lv_obj_update_layout(guider_ui.Key_Mode);
...
void Window_Keyboard_CtrlCV_Loop(void)
{
    if (My_UI.Window_Unlock_Flag == true)
    {
        uint8_t key_trigger = T_Keyboard_S3_Pro_Key_Trigger_Loop();
        ...
        if (key_trigger != false)
        {
            ...
            case My_UI.Window_Keyboard_Key_Trigger_State_Key1_Key2:
                ...
                My_UI.LCD_CS_Set(IIC_MAIN_DEVICE_ADDRESS, 0B00011000, IIC_LCD_CS_DEVICE_DELAY);
            ...
            case My_UI.Window_Keyboard_Key_Trigger_State_Key1_Key3:
                ...
                My_UI.LCD_CS_Set(IIC_MAIN_DEVICE_ADDRESS, 0B00010100, IIC_LCD_CS_DEVICE_DELAY);
